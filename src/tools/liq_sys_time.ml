...
module Sys_time = struct
  ...
  let to_float {tv_sec; tv_usec} =
    Int64.to_float tv_sec +. (Int64.to_float tv_usec /. 1_000_000.)
  ...
  let apply fn x y =
    normalize {tv_sec= fn x.tv_sec y.tv_sec; tv_usec= fn x.tv_usec y.tv_usec}
    ...
    normalize
      {
        ...
        tv_usec=
          Int64.add
            ...
            (Int64.div (Int64.mul x.tv_usec y.tv_usec) 1_000_000L);
      }

  let ( |<| ) x y =
    if Int64.equal x.tv_sec y.tv_sec then x.tv_usec < y.tv_usec
